            ...
            <div>
                ...
                <div>
                    <div className="flex items-center justify-center mb-6">
                        <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-[900px] lg:max-w-[1200px] mx-4 relative">
                            <div className="text-left">
                                <div>
                                    <a
                                        href="https://virginiagarcia.org/"
                                        target="_blank"
                                ...
                                <div>
                                    <a
                                        href="https://i-sos.org/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-sm text-blue-500 hover:underline"
                                    >
                                        Islamic Social Services of Oregon State (I-SOS)
                                    </a>
                                </div>
                                <br />
                                <div>
                                    <a
                                        href="https://bilalmasjid.com/Services/Forms/Bilal_Financial_Aid_Form.pdf"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-sm text-blue-500 hover:underline"
                                    >
                                        Bilal Financial Aid Form
                                    </a>
                                    (Please email the completed form to{' '}
                                    <a className="text-sm text-blue-500 hover:underline" href="mailto:zakat@bilalmasjid.com">
                                        zakat@bilalmasjid.com
                                    </a>{' '}
