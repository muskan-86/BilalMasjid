            ...
            <div>
                ...
                <div>
                    <div className="flex items-center justify-center mb-6">
                        <div className="bg-white p-8 rounded-3xl shadow-md w-11/12 mx-4 relative max-w-screen-lg lg:max-w-screen-xl">
                            <div className="text-left">
                                ...
                                <p>
                                    ...
                                    but still list others. But please do read the Basic Process if you can:
                                    <br /><br />
                                    The best way is to contact PDX Cemetery at 503-473-0563 and they will take care of all arrangements.
                                    <br /><br />
                                    ...
                                    <br />
                                    4. Janaza prayer is performed at Masjid of your choosing.
                                    <br />
                                    5. We drive over to the Cemetery in Funeral Home transportation but in some cases, parents have
                                    elected to carry their deceased child with them in their cars.
                                    <br />
                                    ...
                                    <br /><br />
                                    <strong>Funeral Home:</strong> PDX Cemetery will take care of all arrangements. But should you need to contact the
                                    ...
                                    One thing, to dig the grave, you will need enough manpower. If you think you will get a backhoe, please make sure that you get the permission from ICO. To rent the backhoe, please contact the following:
                                    <br /><br />
