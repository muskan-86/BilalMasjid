            ...
            <div>
                ...
                <div>
                    <div className="flex items-center justify-center mb-6">
                        <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-[800px] lg:max-w-[1000px] mx-4">
                            <div className="text-left leading-relaxed">
                                ...
                                <p>
                                    ...
                                    and Practitioners in Oregon, this form needs to be provided to the{' '}
                                    <strong>person in charge of the remains of the deceased</strong>, before the Janaza at the Masjid, with instructions:
                                    <br /><br />
                                    a. That it be clearly filled and signed by the person <strong>in charge of the remains of the deceased</strong>.
                                    <br />
                                    b. That the person in charge of the remains of the deceased MUST bring it with the remains of the
                                    deceased when the Mayyat is brought to the relevant cemetery for burial.
                                    <br /><br />
                                    No burial is legally permitted UNLESS the family of the deceased presents this document that is
                                ...
                                <div>
                                    <a
                                        href="https://www.bilalmasjid.com/Services/Funeral/Final%20authorization%20for%20burial%205.pdf"
                                        target="_blank"
                                ...
                                <p>
                                    ...
                                    Click{' '}
                                    <a
                                        href="http://wikimapia.org/#lang=en&lat=44.558074&lon=-123.329853&z=18&m=w"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-blue-500 hover:underline"
                                    >
